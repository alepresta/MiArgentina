...
Then /^Se verificara la tarjeta Donación de Órganos 20258489749$/ do
  ...
  texto_tarjeta_organos = 'No quiero ser donante'
  esIgual(texto_tarjeta_organos, tarjeta_organos, 'Quiero ser donante:')
  texto_tarjeta_organos = 'Manifestación en oposición a la donación de órganos y tejidos.'
  esIgual(texto_tarjeta_organos, tarjeta_organos, 'Manifestación en oposición a la donación de órganos y tejidos.:')
  ...
  texto_tarjeta_organos = '28/05/2018'
  esIgual(texto_tarjeta_organos, tarjeta_organos, '28/05/2018:')
...
Then /^Se verificara la tarjeta Detalles Donación de Órganos 20258489749$/ do
  ...
  texto_campo_manifestacion = 'No quiero ser donante'
  esIgual(texto_campo_manifestacion, campo_manifestacion, 'Manifestación de oposición a la donación de órganos y tejidos.:')
  fecha_de_expresión = capturar(:xpath,'/html/body/main/section[2]/div/div/div/div/div/div/div[2]/div/div[4]/p/b').text
  texto_fecha_de_expresión = '28/05/2018'
  ...
  texto_campo_Nombres = 'ANTONELLA MELISA'
  ...
  texto_campo_numero_documento = '11.026.230'
